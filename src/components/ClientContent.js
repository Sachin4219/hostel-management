    ...
    return (
        <div className="clientContent">
            ...
            <div className="quickActionBlock">
                ...
                <a href='/'><QuickAction iconClass={svg.write[0]} path={svg.write[1]} fillRule={svg.write[3]} path2={svg.write[2]} number={2} title='File Complaint' /></a>
                <a href='/'><QuickAction iconClass={svg.status[0]} path={svg.status[1]} number={3} title='View Complaint Status' /></a>
